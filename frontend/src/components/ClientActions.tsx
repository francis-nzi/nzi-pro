...
export default function ClientActions({
  ...
  const loadData = useCallback(async () => {
    ...
    setError("");
    try {
      const res = await fetch(`${baseUrl}/clients/${clientDbId}/report-actions`, {
        credentials: "include",
      });
      if (!res.ok) {
  ...
  function updateItem(index: number, patch: Partial<ClientActionItem>) {
    setItems((prev) =>
      ...
      <Card>
        <CardHeader className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
          <div className="space-y-1">
            ...
            <CardDescription>
              Build a shared decarbonisation action plan for this client, drawn from the suggested library or added as custom actions. This list is shared across every job/reporting year for this client.
            </CardDescription>
          </div>
        ...
        <CardHeader>
          <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div className="space-y-1">
              ...
              <CardDescription>
                Start with reusable admin-managed actions, then tailor them for this client after adding them.
              </CardDescription>
            </div>
