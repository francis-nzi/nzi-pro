...
export default function InvoiceDetailPage() {
  ...
  async function createCreditNote() {
    ...
    setStatus("");
    try {
      const res = await fetch(`${baseUrl}/invoices/${invoiceId}/credit-notes`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
        body: JSON.stringify({}),
      ...
      const cn = await res.json() as { credit_note_id: number };
      router.push(`/clients/${clientId}/credit-notes/${cn.credit_note_id}`);
    } catch (e) {
      setError((e as Error).message);
    } finally {
      setSaving(false);
        ...
        <PageHeader
          ...
          actions={
            <div className="flex flex-wrap items-center gap-2">
              ...
              <ActivityHistoryModal url={`/invoices/${invoiceId}/history`} baseUrl={baseUrl} label="History" />
        ...
        <Card className="mt-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button variant="outline" onClick={createCreditNote} disabled={saving}>Create Credit Note</Button>
