...
def run_migrations():
    with get_conn() as con:
        if db_backend() == "postgres":
            ...
            con.execute("ALTER TABLE clients ADD COLUMN IF NOT EXISTS engagement_start_date DATE")
            con.execute("ALTER TABLE clients ADD COLUMN IF NOT EXISTS engagement_end_date DATE")
            con.execute("ALTER TABLE clients ADD COLUMN IF NOT EXISTS touchpoint_cadence VARCHAR DEFAULT 'monthly'")
        ...
        for _idx_sql in [
            ...
            try:
                ...
                logger.warning("Ignoring 0052 perf index: %s", exc)
