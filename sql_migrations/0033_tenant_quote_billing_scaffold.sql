...
ALTER TABLE quotes ADD COLUMN IF NOT EXISTS org_id VARCHAR;
ALTER TABLE quote_lines ADD COLUMN IF NOT EXISTS org_id VARCHAR;
ALTER TABLE quote_email_log ADD COLUMN IF NOT EXISTS org_id VARCHAR;
ALTER TABLE invoices ADD COLUMN IF NOT EXISTS org_id VARCHAR;
ALTER TABLE invoice_lines ADD COLUMN IF NOT EXISTS org_id VARCHAR;
ALTER TABLE invoice_email_log ADD COLUMN IF NOT EXISTS org_id VARCHAR;
ALTER TABLE job_other_costs ADD COLUMN IF NOT EXISTS org_id VARCHAR;
