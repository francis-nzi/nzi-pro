...
7. S3-6: immutable org context in async work
8. S3-7: org switching and support UX
9. S3-8: regression coverage
10. S3-9: remove legacy operational fallback paths
