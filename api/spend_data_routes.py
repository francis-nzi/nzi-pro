...
def download_spend_template(
    ...
    file_name = "-".join(
        [
            _safe_filename_part(job_number).replace(" ", "-"),
            _safe_filename_part(client_name).replace(" ", "-"),
            _safe_filename_part(site_label).replace(" ", "-"),
            "Spend-Template",
            _safe_filename_part(reporting_period_label).replace(" ", "-"),
        ]
    ) + ".xlsx"
    return Response(
