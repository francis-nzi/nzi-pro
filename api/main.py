...
from api.admin_factor_definitions_routes import router as admin_factor_definitions_router
from api.admin_spend_lines_routes import router as admin_spend_lines_router
...
from api.portal_vehicle_routes import router as portal_vehicle_router
...
app.include_router(admin_factor_definitions_router)
app.include_router(admin_spend_lines_router)
...
app.include_router(portal_vehicle_router)
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://127.0.0.1:3000",
        "http://127.0.0.1:3001",
        "https://www.nzinsights.co.uk",
        "https://nzinsights.co.uk",
    ],
