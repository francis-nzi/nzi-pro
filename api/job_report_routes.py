    ...
    *,
    ...
    version_row = con.execute(
        ...
        INSERT INTO job_report_versions (
          job_id, client_db_id, version_number, version_label, status, report_format,
        ...
        VALUES (%s, %s, %s, %s, %s, 'pdf', %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
...
def get_job_data(job_id: int):
    ...
    with get_conn() as con:
        job_row = con.execute("""
            SELECT j.job_id, j.client_db_id, j.job_number, j.title, j.reporting_year, j.status,
        ...
        return {
            ...
            'job_number': job_row[2],
            'title': job_row[3],
            'reporting_year': job_row[4],
            'status': job_row[5],
            'period_start': job_row[6],
            'period_end': job_row[7],
            'client_name': job_row[8],
            'crm_owner': job_row[9],
            'industry': job_row[10],
            'logo_url': job_row[11],
            'client_logo_url': job_row[11],  # alias used by interactive_report.html
            'description': job_row[12],
            'net_zero_year': job_row[13],
            'interim_year': job_row[14],
            'benchmark_year': job_row[15],
            'benchmark_period_start': job_row[16],
            'benchmark_period_end': job_row[17],
            'interim_s1_pct': job_row[18],
            'interim_s2_pct': job_row[19],
            'interim_s3_pct': job_row[20],
            'target_s1_year': job_row[21],
            'target_s2_year': job_row[22],
            'target_s3_year': job_row[23],
            'target_s1_pct': job_row[24],
            'target_s2_pct': job_row[25],
            'target_s3_pct': job_row[26],
            'city': job_row[27],
            'country': job_row[28],
    ...
    if current_row:
        ...
        con.execute(
            ...
            INSERT INTO job_report_drafts (
              job_id, template_id, version_id, section_key, section_title, draft_text, draft_json,
