...
def _serialize_report_version_row(row: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "version_label": _safe_str(row.get("version_label")),
        "status": _safe_str(row.get("status")),
        "report_format": _safe_str(row.get("report_format")),
        ...
        "storage_provider": _safe_str(row.get("storage_provider")),
        "external_item_id": _safe_str(row.get("external_item_id")),
        "external_web_url": _safe_str(row.get("external_web_url")),
        "external_path": _safe_str(row.get("external_path")),
        "data_hash": _safe_str(row.get("data_hash")),
        "notes": _safe_str(row.get("notes")),
        "generated_at": _safe_str(row.get("generated_at")),
        "generated_by": _safe_str(row.get("generated_by")),
        "reviewed_at": _safe_str(row.get("reviewed_at")),
        "reviewed_by": _safe_str(row.get("reviewed_by")),
        "finalized_at": _safe_str(row.get("finalized_at")),
        "finalized_by": _safe_str(row.get("finalized_by")),
        "superseded_at": _safe_str(row.get("superseded_at")),
        "superseded_by": _safe_str(row.get("superseded_by")),
