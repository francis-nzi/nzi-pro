...
def get_job_data(job_id: int):
    ...
    with get_conn() as con:
        ...
        return {
            ...
            'benchmark_year': job_row[14],
            'benchmark_period_start': job_row[15],
            'benchmark_period_end': job_row[16],
            'interim_s1_pct': job_row[17],
            'interim_s2_pct': job_row[18],
            'interim_s3_pct': job_row[19],
            'target_s1_year': job_row[20],
            'target_s2_year': job_row[21],
            'target_s3_year': job_row[22],
            'target_s1_pct': job_row[23],
            'target_s2_pct': job_row[24],
            'target_s3_pct': job_row[25],
            'city': job_row[26],
            'country': job_row[27],
