...
def list_lookup_items(
    ...
    allowed_tables = [
        ...
        "governance_subjects_lookup", "lca_material_categories_lookup", "referrals_lookup", "client_teams_lookup",
    ]
...
def permanently_delete_lookup_item(
    ...
    id_col_map = {
        ...
        "referrals_lookup": "referral_id",
        "client_teams_lookup": "client_team_id",
    }
