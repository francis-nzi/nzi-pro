...
| S2-9 | Add stage 2 regression coverage | P1 | Complete | You | 2026-07-17 | S2-2, S2-3, S2-4, S2-5 | `Files: tests/test_stage2_regressions.py, tests/test_org_lifecycle.py, tests/test_auth_routes.py, tests/test_main_tenancy.py, tests/test_permissions.py, tests/test_business_development_limits.py, tests/test_pdf_tenancy.py, tests/test_tenant_observability.py; tests: python -m pytest tests/test_stage2_regressions.py tests/test_org_lifecycle.py tests/test_auth_routes.py, python -m pytest tests/test_main_tenancy.py tests/test_permissions.py tests/test_business_development_limits.py tests/test_pdf_tenancy.py tests/test_tenant_observability.py; notes: archived org switching, owner normalization, and current-org fallback summary are now covered` |
